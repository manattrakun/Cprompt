...
// btnSettings moved inside setupSettingsModalconst settingsModal=document.getElementById('settings-modal');const closeSettingsBtn=document.getElementById('close-settings');const cancelSettingsBtn=document.getElementById('btn-cancel-settings');const saveSettingsBtn=document.getElementById('btn-save-settings');const geminiApiKeyInput=document.getElementById('gemini-api-key');const quotaModal=document.getElementById('quota-modal');const closeQuotaModalBtn=document.getElementById('close-quota-modal');const btnCloseQuotaModal=document.getElementById('btn-close-quota-modal');const veo3AspectRatioSelect=document.getElementById('veo3-aspect-ratio');
